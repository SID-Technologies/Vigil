...
// The OutageFunc type is an adapter to allow the use of ordinary
// function as Outage mutator.
type OutageFunc func(context.Context, *ent.OutageMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f OutageFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.OutageMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.OutageMutation", m)
}
...
// The Sample1hFunc type is an adapter to allow the use of ordinary
// function as Sample1h mutator.
type Sample1hFunc func(context.Context, *ent.Sample1hMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f Sample1hFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.Sample1hMutation); ok {
		return f(ctx, mv)
	}
...
// Mutate calls f(ctx, m).
func (f Sample5minFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.Sample5minMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.Sample5minMutation", m)
}
...
// The WifiSampleFunc type is an adapter to allow the use of ordinary
// function as WifiSample mutator.
type WifiSampleFunc func(context.Context, *ent.WifiSampleMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f WifiSampleFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.WifiSampleMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.WifiSampleMutation", m)
}
